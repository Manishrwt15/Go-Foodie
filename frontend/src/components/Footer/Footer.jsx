...
const Footer = () => {
  return (
    <div
      id="contact-us"
      className="text-[#d9d9d9] bg-[#323232] flex flex-col items-center gap-[20px] pt-[80px] px-[8vw] mt-[100px]"
    >
      <div className="w-full flex flex-col md:grid md:grid-cols-[2fr_1fr_1fr] gap-[30px] md:gap-[80px] ">
        ...
        <div className="flex flex-col gap-[20px] items-start">
          ...
          <p>
            Nulla labore dolore dolore veniam esse ea eu pariatur nisi et anim.
          </p>
          <div className="flex">
            <img
        ...
        <div className="flex flex-col items-start gap-[20px]">
          ...
          <ul>
            ...
            <li className="mb-[10px] [list-style:none] cursor-pointer">
              About us
            </li>
            <li className="mb-[10px] [list-style:none] cursor-pointer">
              Delivery
      ...
      <p className="text-center">
        Copyright 2024 &copy; GoFoodie.com - All Right Reserved.
      </p>
    </div>
  );
};
