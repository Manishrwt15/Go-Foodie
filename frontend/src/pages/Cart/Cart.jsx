    ...
    <div className="mt-[100px]">
      ...
      <div className="mt-[80px] flex justify-between gap-[max(12vw,20px)] flex-col-reverse md:flex-row">
        <div className="flex-1 flex flex-col gap-[20px]">
          ...
          <button
            className="border-none bg-[#DF5E11] w-[max(15vw,200px)] py-[12px] px-[2px] rounded-[4px] cursor-pointer text-white"
        ...
        <div className="justify-start">
          <div className="flex-1">
            <p className="text-[#555]">
              If you hava a promo code, Enter it here
            </p>
            <div className="mt-[10px] flex justify-between items-center bg-[#eaeaea] rounded-[4px]">
              ...
              />
              <button className="bg-black w-[max(10vw,150px)] py-[12px] px-[5px] border-none text-white rounded-[4px]">
                APPLY
              </button>
            </div>
          </div>
